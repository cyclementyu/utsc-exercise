...
def get_avg_salary_by_country(employee_salary_df: pd.DataFrame, selected_countries: list):
    ...
    # Group by countries and calculate the average salary
...
def get_num_employees_by_country(employee_salary_df: pd.DataFrame, selected_countries: list):
    ...
    # Group by Country and get the count of employees
    num_employees_by_country = filtered_df.groupby('Country').size().reset_index(name='NumEmployees')
...
def get_num_employees_by_job_title(employee_salary_df: pd.DataFrame, selected_titles: list):
    ...
    # Group by JobTitle and get the count of employees
    num_employees_by_job_title = filtered_df.groupby('JobTitle').size().reset_index(name='NumEmployees')
